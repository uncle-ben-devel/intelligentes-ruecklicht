...
%     ohnedc1 = exp_moving_avg(ohnedc0, 0.1);
    ...
    mean_filter = exp_ma_zweistufig(mean_filter, 0.1, 0.04);
...
brems_est_vec1 = (mean_filter < -0.5);
brems_est_vec = -12*(brems_est_vec0 & brems_est_vec1);
%   brems_est_vec = hysterese(brems_est_vec, 0.05, 0.15, f_sample);


%% Plotten
      plot_compare(accel_raw, std_filter, mean_filter, brems_est_vec, brems_vec, t_vec, fahrtinfo);
