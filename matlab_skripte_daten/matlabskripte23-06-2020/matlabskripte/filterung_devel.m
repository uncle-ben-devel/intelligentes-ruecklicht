...
% BNO055 V3 Fahrt 27++, ADXL Fahrt 32++
    filename = 'Fahrt29_BNO055.txt';    %Fahrt30 worst case
...
%% Plotten
     plot_compare(accel_raw, accel_raw, lokale_abweichung(accel_raw, filterbreite), brems_est_vec , brems_vec, t_vec, fahrtinfo);
