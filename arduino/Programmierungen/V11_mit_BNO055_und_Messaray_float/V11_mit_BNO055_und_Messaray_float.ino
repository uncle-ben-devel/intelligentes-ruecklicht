...
#define WegProTrigger 0.35833  //6 Trigger je Umdrehung, Gesamtumfang = 215cm @ 90kg
...
typedef struct MessElement {float x_AccelMess; byte Brake_Mess; float TachoAccel_Mess;};
...
void SaveMessurementToArray(){
  ...
  SpeicherArray[ii].TachoAccel_Mess = BeschleunigungTacho;
...
//      Serial.print("\t");
      ...
      Serial.print("\t");
      Serial.print(SpeicherArray[aa].TachoAccel_Mess, 20);
      Serial.println("\t");
