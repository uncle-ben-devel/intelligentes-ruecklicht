...
void SaveMessurementToArray(){
  ...
  SpeicherArray[ii].x_AccelMess = AccelData.acceleration.x;
  SpeicherArray[ii].y_AccelMess = AccelData.acceleration.y;
  SpeicherArray[ii].z_AccelMess = AccelData.acceleration.z;
